...
Public Class PluginVersionInfo
    ...
    Public ReadOnly Property m_PluginVersionInformation As IPluginVersionInterface.STRUC_PLUGIN_VERSION_INFORMATION Implements IPluginVersionInterface.m_PluginVersionInformation
        Get
            Return New IPluginVersionInterface.STRUC_PLUGIN_VERSION_INFORMATION("https://raw.githubusercontent.com/Timocop/BasicPawn/master/Plugin%20Releases/BasicPawnPluginTranslationEditor/CurrentVersion.txt")
        End Get
    End Property
End Class
