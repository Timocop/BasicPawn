    ...
    Private Sub ToolStripMenuItem_FindOptimalConfigAllTabs_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem_FindOptimalConfigAllTabs.Click
        For Each mTab In g_ClassTabControl.GetAllTabs
            ...
            Else
                ...
                g_ClassAutocompleteUpdater.StartUpdateSchedule(ClassAutocompleteUpdater.ENUM_AUTOCOMPLETE_UPDATE_TYPE_FLAGS.ALL, mTab, ClassAutocompleteUpdater.ENUM_AUTOCOMPLETE_UPDATE_OPTIONS_FLAGS.FORCE_UPDATE)
