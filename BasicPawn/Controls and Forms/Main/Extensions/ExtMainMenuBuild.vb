    ...
    Private Sub ToolStripMenuItem_BuildCurrent_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem_BuildCurrent.Click
        Try
            Using mProgress As New FormProgress
                ...
                g_ClassTextEditorTools.CompileSource(Nothing, Nothing, sSource, False, True, sOutputFile, Nothing, If(sSourceFile Is Nothing, Nothing, IO.Path.GetDirectoryName(sSourceFile)), Nothing, Nothing, sSourceFile)
        ...
        Try
            Using mProgress As New FormProgress
                ...
                For Each mTab In g_ClassTabControl.GetAllTabs
                    ...
                    Dim bSuccess = g_ClassTextEditorTools.CompileSource(mTab, Nothing, sSource, False, True, sOutputFile, mTab.m_ActiveConfig, If(sSourceFile Is Nothing, Nothing, IO.Path.GetDirectoryName(sSourceFile)), Nothing, Nothing, sSourceFile, True, sCompilerOutput)
