        ...
        Try
            Using mProgress As New FormProgress
                ...
                For Each mTab In g_ClassTabControl.GetAllTabs
                    ...
                    Dim bSuccess = g_ClassTextEditorTools.CompileSource(False, sSource, sOutputFile, mTab.m_ActiveConfig, If(sSourceFile Is Nothing, Nothing, IO.Path.GetDirectoryName(sSourceFile)), mTab.m_ActiveConfig.g_sCompilerPath, mTab.m_ActiveConfig.g_sIncludeFolders, sSourceFile, True, sCompilerOutput)
