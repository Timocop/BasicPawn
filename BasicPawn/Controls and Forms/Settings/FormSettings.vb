...
Public Class FormSettings
    ...
    Public Sub ApplySettings()
        ...
        For j = 0 To g_mFormMain.g_ClassTabControl.m_TabsCount - 1
            g_mFormMain.g_ClassAutocompleteUpdater.StartUpdate(ClassAutocompleteUpdater.ENUM_AUTOCOMPLETE_UPDATE_TYPE_FLAGS.ALL, g_mFormMain.g_ClassTabControl.m_Tab(j))
        Next
