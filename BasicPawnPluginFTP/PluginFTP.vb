...
#End Region
    ...
    Public ReadOnly Property m_PluginInformation As IPluginInterfaceV3.STRUC_PLUGIN_INFORMATION Implements IPluginInterfaceV3.m_PluginInformation
        Get
            Return New IPluginInterfaceV3.STRUC_PLUGIN_INFORMATION("FTP Plugin",
                                                                 "Timocop",
    ...
    Class ClassPlugin
        ...
        Private Sub OnCompileItemClick(sender As Object, e As EventArgs)
            Try
                ...
                g_mPluginFTP.g_mFormMain.g_ClassTextEditorTools.CompileSource(Nothing, Nothing, sSource, False, sOutputFile, Nothing, If(sSourceFile Is Nothing, Nothing, IO.Path.GetDirectoryName(sSourceFile)), Nothing, Nothing, sSourceFile)
